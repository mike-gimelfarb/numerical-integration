...
public final class GaussKronrod extends Quadrature {
    ...
    private static final double[] WG21 = { 0.066671344308688137593568809893332, 0.149451349150580593145776339657697,
	    0.219086362515982043995534934228163, 0.269266719309996355091226921569469,
	    0.295524224714752870173892994651338 };
    private static final double[] XGK21 = { 0.995657163025808080735527280689003, 0.973906528517171720077964012084452,
    ...
    private static final double[] WGK21 = { 0.011694638867371874278064396062192, 0.032558162307964727478818972459390,
    ...
    private static final double[] WG15I = { 0.0000000000000000, 0.1294849661688697, 0.0000000000000000,
	    0.2797053914892767, 0.0000000000000000, 0.3818300505051189, 0.0000000000000000, 0.4179591836734694 };
    private static final double[] XGK15I = { 0.9914553711208126, 0.9491079123427585, 0.8648644233597691,
	    0.7415311855993944, 0.5860872354676911, 0.4058451513773972, 0.2077849550078985, 0.0000000000000000 };
    private static final double[] WGK15I = { 0.02293532201052922, 0.06309209262997855, 0.1047900103222502,
     ...
     */
    public GaussKronrod(final double tolerance, final double relativeTolerance, final int levels) {
	super(tolerance);
	myRelTol = relativeTolerance;
	myLevels = levels;
    }

    public GaussKronrod(final double tolerance) {
	...
	dqags1(f, a, b, myTol, myRelTol, result, abserr, neval, ier, myLevels);
	myFEvals += neval[0];
	...
	// call main subroutine
	dqagi1(f, bound, inf, myTol, myRelTol, result, abserr, neval, ier, myLevels);
	myFEvals += neval[0];
	return ier[0] == 0 ? result[0] : Double.NaN;
    }

    private static void dqelg(final int[] n, final double[] epstab, final double[] result, final double[] abserr,
	    final double[] res3la, final int[] nres) {

	double delta1, delta2, delta3, epmach, epsinf, error, err1, err2, err3, e0, e1, e1abs, e2, e3, oflow, res, ss,
		tol1, tol2, tol3;
    ...
    private static void dqpsrt(final int limit, final int last, final int[] maxerr, final double[] ermax,
    ...
    private static void dqk21(final Function<? super Double, Double> f, final double a, final double b,
	    final double[] result, final double[] abserr, final double[] resabs, final double[] resasc) {

	double absc, centr, dhlgth, epmach, fc, fsum, fval1, fval2, hlgth, resg, resk, reskh, uflow;
	int j, jtw, jtwm1;
	final double[] fv1 = new double[11], fv2 = new double[11];
    ...
    private static void dqagse(final Function<? super Double, Double> f, final double a, final double b,
	...
	final double[] res3la = new double[4], rlist2 = new double[53], abseps = new double[1], area1 = new double[1],
		area2 = new double[1], defabs = new double[1], defab1 = new double[1], defab2 = new double[1],
		errmax = new double[1], error1 = new double[1], error2 = new double[1], resabs = new double[1],
		reseps = new double[1];
    ...
    private static void dqags1(final Function<? super Double, Double> f, final double a, final double b,
